...
```{r, echo=FALSE}
embed_url("https://www.youtube.com/watch?v=KvfqOeWtNyM")
```
...
```{r, echo=FALSE}
embed_url("https://www.youtube.com/watch?v=YaBOqrWhZfM")
```
...
```{r, echo=FALSE}
embed_url("https://www.youtube.com/watch?v=bRhdN3z2OUI")
```
...
```{r, echo=FALSE}
embed_url("https://www.youtube.com/watch?v=Qs4IBYUAoiY")
```
